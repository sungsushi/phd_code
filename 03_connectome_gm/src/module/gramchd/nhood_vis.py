...
from .gmd import matching_euclidean_distance
...
def get_graph_traces_plotly(G, seed=0, g=1, layout=None, labelling=False, directed=True):
    '''
...
### from contact_maps/11_pair_comparisons.ipynb

def plot_two_graphs_from_output(output, s_ids, directed=True, seed=0, labelling=True):
    '''
    Given the output which is a dictionary of graphs 1 and 2 with precomputed layouts and distance metrics. 
    '''
